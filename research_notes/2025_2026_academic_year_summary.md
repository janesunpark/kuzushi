...
A shared pattern also emerged around familiar routines and regulation. In the spring semester, worksheet tasks, reward systems, and repeated session structres appeared to become familiar routines that supported both co-regulation and self-directed regulation. However, each learner used these routines differently. S01 often relied on proximity, quiet presence, and shared attention to return to tasks during moments uncertainty or comparison. S02 more often used brief separation, competitive play, or self-directed reset before re-engaging. In both cases, calm continuation of the session appeared to support recovery without escalating the moment.

Both learners also developed familiarity-based entry points in problem-solving. In challenging spatial puzzles with greater constraints or unfamiliar structures, both S01 and S02 often completed familiar patterns first before adjusting to the rest of the task. When puzzles were framed as playful exploration rather than performance tasks, neither learners appeared primarily focused on efficiency. Instead, book took time observing patterns, manipulating shapes, testing approaches, and applying previously learned concepts independently. 
